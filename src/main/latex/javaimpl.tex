...
Každá třída \type{cz.rank.vsfs.mindex.MultiLevelMIndex} a \type{cz.rank.vsfs.mindex.DynamicMIndex} má konstruktor, který má parametr pro předpočítanou maximální vzdálenost.
\item Zahřátí JVM.
...
Parametry \MIndex{u} byly: více-stupňový cluster 3, počet pivotů 10 a stupeň \BPTree{} 50.
