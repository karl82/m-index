...
Důvod, proč konfigurace s nízkým počet pivotů jsou dominantní, je v tom, že v této množině objektů pro vyhledání, jsou objekty shlukovány kolem konkrétních pivotů.
Při filtrování v \emph{Range Query}
\todo{Proc tomu tak je}
