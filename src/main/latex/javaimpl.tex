...
\item Vypsání informací o měření -- parametry a čas strávený hledáním.
...
Během měření žádné další uživatelské procesy neběželi, aby nedošlo k ovlivnění měření.
...
Při práci s tímto množstvím docházelo k přetečení typu \type{Integer} v kolekcích a nesmyslným výsledkům.\footnote{V Java může typ \type{Integer} pojmout maximálně $2^{31}-1$ hodnot}

Při tomto množství je celkový počet kombinací parametrů 252 pro dynamický cluster a 36 pro více-stupňový cluster. Jelikož počet měření je 20 pro každý parametr, bylo celkově vykonáno 5760 měření.
...
\caption{JVM1 počet pivotů 10 a 20\label{fig:jvm1p1020}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics{jvm1_p30}
\includegraphics{jvm1_p50}
\caption{JVM1 počet pivotů 30 a 50\label{fig:jvm1p3050}}
\end{figure}
...
\caption{JVM2 počet pivotů 10 a 20\label{fig:jvm2p1020}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics{jvm2_p30}
\includegraphics{jvm2_p50}
\caption{JVM2 počet pivotů 30 a 50\label{fig:jvm2p3050}}
\end{figure}
...
\caption{JVM3 počet pivotů 10 a 20\label{fig:jvm3p1020}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics{jvm3_p30}
\includegraphics{jvm3_p50}
\caption{JVM3 počet pivotů 30 a 50\label{fig:jvm3p3050}}
\end{figure}
...
\caption{JVM4 počet pivotů 10 a 20\label{fig:jvm4p1020}}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics{jvm4_p30}
\includegraphics{jvm4_p50}
\caption{JVM4 počet pivotů 30 a 50\label{fig:jvm4p3050}}
\end{figure}
