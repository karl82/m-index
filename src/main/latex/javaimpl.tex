...
\item Zda byl použit dynamický nebo více-stupňový \MIndex{}
...
Rozhodl jsem se pro porovnání použít konfiguraci s~nejlepším časem dosaženým v~Java -- dynamický \MIndex{} s~maximálním počtem 20 objektů v~listu a se stupněm \BPTree{} 500 a JVM1, a také nejhorším časem -- více-stupňový \MIndex{} se stupněm \BPTree{} 50 a JVM4.
