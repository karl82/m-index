...
\MIndex{} zobecňuje iDistance tak, že může být použita na~obecné metrické
...
\begin{figure}[t]
\begin{centering}
\includegraphics[scale=0.5]{m-index-level-one}\caption{\MIndex{} prvního stupně $(l=1)$\label{fig:M-Index-level-one}}
...
Koncept \MIndex{u} může být rozšířen o~\emph{dynamický počet stupňů},
...
\begin{figure}[t]
\centering{}
\includegraphics[scale=0.5]{m-index-dynamic-cluster}\caption{\label{fig:Dynamic-Cluster-Tree}}
\end{figure}
