...
Text a obrázky v~této kapitole jsou více méně opisem a překladem z~původního popisu \MIndex{u}\cite{Novak:2009:MIE:1637863.1638184}.
...
\emph{iDist} klíčů, které musejí být k~vyřízení dotazu. %%% co jsem chtel rict??
...
%\prettyref{fig:M-Index-level-two} ukazuje příklad \MIndex{u} pro $l=2$\@.
...
Koncept \MIndex{u} může být rozšířen o~dynamický počet stupňů, který umožní \prettyref{eq:M-Index-key} dynamicky zvětšovat (prohlubovat)
...
na~\prettyref{fig:Dynamic-Cluster-Tree}. Prvky mají přiřazeny
%%% obrazek
